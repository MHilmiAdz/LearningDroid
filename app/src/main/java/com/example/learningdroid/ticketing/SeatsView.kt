...
class SeatsView : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val text = "Please Pick Your Seat"
        titlePaint.apply {
            textSize = 50F
            color = MaterialColors.getColor(context, com.google.android.material.R.attr.colorOnSurface, android.graphics.Color.BLACK)
        }
        canvas.drawText(text, (width / 4F), 100F, titlePaint)
    }
