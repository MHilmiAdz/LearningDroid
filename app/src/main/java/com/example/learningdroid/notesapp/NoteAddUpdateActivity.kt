...
import com.example.learningdroid.databinding.ActivityNoteAddUpdateBinding
import com.example.learningdroid.notesapp.db.DatabaseContract
...
class NoteAddUpdateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showAlertDialog(type: Int) {
        ...
        if (isDialogClose) {
            dialogTitle = "Cancel"
            dialogMessage = "Are you sure want to cancel?"
        } else {
            dialogMessage = "Delete note?"
            dialogTitle = "Delete"
        }
