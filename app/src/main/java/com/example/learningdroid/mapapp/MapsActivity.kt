package com.example.learningdroid.mapapp
...
import com.example.learningdroid.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val theGrandMosque = LatLng(24.46757208910554, 39.610983795019976)
        mMap.addMarker(
            MarkerOptions()
                .position(theGrandMosque)
                .title("Al Masjid an-Nabawi")
                .snippet("Al Haram, Madinah 42311, Saudi Arabia")
        )
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(theGrandMosque, 15f))
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(
                MarkerOptions()
                    ...
                    .icon(vectorToBitmap(R.drawable.ic_mosque, "#3DDC84".toColorInt()))
            )
        }
