package com.example.learningdroid.sharedpref
...
import com.example.learningdroid.databinding.ActivitySharedPrefBinding
...
class SharedPrefActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun populateView(userModel: UserModel) {
        ...
        binding.tvAge.text = userModel.age.toString().ifEmpty { "Empty" }
        binding.tvFavfood.text = if (userModel.isLove) "Pizza" else "Not Pizza"
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            val intent = Intent(this@SharedPrefActivity, FormUserPreferenceActivity::class.java)
            when {
                isPreferenceEmpty -> {
                    intent.putExtra(
