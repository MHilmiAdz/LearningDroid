...
class SimpleNotifActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOpenDetail.setOnClickListener{
            sendNotificationDetail(title, message)
            val detailIntent = Intent(this@SimpleNotifActivity, DetailActivity::class.java)
    ...
    private fun sendNotificationDetail(title: String, message: String) {
