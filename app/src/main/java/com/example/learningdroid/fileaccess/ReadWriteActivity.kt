package com.example.learningdroid.fileaccess
...
import com.example.learningdroid.databinding.ActivityReadWriteBinding
...
class ReadWriteActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile() {
        when {
            ...
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(this, "Content is empty", Toast.LENGTH_SHORT).show()
            else -> {
