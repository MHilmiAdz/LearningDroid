package com.example.learningdroid.restoreview
...
import com.example.learningdroid.databinding.ActivityRestoReviewBinding
import com.example.learningdroid.restoreview.data.response.CustomerReviewsItem
import com.example.learningdroid.restoreview.data.response.PostReviewResponse
...
class RestoReviewActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityRestoReviewBinding
    companion object {
        private const val TAG = "RestoReviewActivity"
        private const val RESTAURANT_ID = "uewq1zg2zlskfw1e867"
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRestoReviewBinding.inflate(layoutInflater)
    ...
    private fun setRestaurantData(restaurant: Restaurant) {
        ...
        Glide.with(this@RestoReviewActivity)
