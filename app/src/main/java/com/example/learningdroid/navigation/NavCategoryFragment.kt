...
import com.example.learningdroid.databinding.FragmentNavCategoryBinding
...
class NavCategoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCategoryLifestyle.setOnClickListener { view ->
            val toDetailCategoryFragment = NavCategoryFragmentDirections.actionNavCategoryFragmentToNavDetailCategory()
